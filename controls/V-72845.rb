control 'V-72845' do
  ...
  current_psql_version = command('psql --version').stdout.strip

  describe 'This test must be performed by manual interview of the dba or sysadmin' do
    skip "This test must be preformed manually, please review if
          #{current_psql_version} is the most current version publically availability at
          http://www.postgresql.org/support/versioning/"
  end
end
